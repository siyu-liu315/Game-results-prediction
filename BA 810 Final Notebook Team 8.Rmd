...
```{r}
results_df_train <- ggplot(results_df, aes(x = minute, y = Train_Error_Rate)) + 
  geom_line() +
  geom_point()+
  ggtitle("Train Error Rate By Minute") 

ggplotly(results_df_train)
...
```{r}
results_df_test <- ggplot(results_df, aes(x = minute, y = Test_Error_Rate)) + 
  geom_line() +
  geom_point()+
  ggtitle("Test Error Rate By Minute")

ggplotly(results_df_test)
```
