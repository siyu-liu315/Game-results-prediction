...
```{r}
train_tree <- train_tree %>% select(-X15.baron_accum, -X15.elder_dragon_accum,-X15.nexus_turret_accum)
test_tree <- test_tree %>% select(-X15.baron_accum,-X15.elder_dragon_accum,-X15.nexus_turret_accum)
